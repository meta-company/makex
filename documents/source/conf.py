...
html_theme = os.environ.get("SPHINX_THEME", "metacompany")
...
html_theme_options = {
    ...
    'google_analytics_tag': 'G-NWZ09K8RTV',
    "edit_source": True,
    "extra_links": [
        # ExtraLink("Configuration", page="configuration"),
        {"label": "Documentation", "page": "index"},
        {"label": "Install", "page": "install"},

        {"label": "PyPI", "url": "https://pypi.org/project/makex/"},
        {"label": "SourceHut", "url": "https://hg.sr.ht/~metacompany/makex"},
        {"label": "GitHub", "url": "https://github.com/meta-company/makex"},
    ],
}
# yapf: enable
...
if AUTODOC:
    ...
    autodoc_type_aliases = {"Union": "typing.Union"}
